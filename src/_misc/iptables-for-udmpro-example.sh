...
iptables -t nat -A PREROUTING -s 192.168.52.110,192.168.52.111,192.168.52.112,192.168.52.113 -p tcp --dport 53 -j ACCEPT
iptables -t nat -A PREROUTING -s 192.168.52.110,192.168.52.111,192.168.52.112,192.168.52.113 -p UDP --dport 53 -j ACCEPT
iptables -t nat -A PREROUTING -p tcp --dport 53 -j DNAT --to 192.168.52.110
iptables -t nat -A PREROUTING -p udp --dport 53 -j DNAT --to 192.168.52.110
...
iptables -t nat -A POSTROUTING -s 192.168.52.110,192.168.52.111,192.168.52.112,192.168.52.113 -j ACCEPT
iptables -t nat -A POSTROUTING -m iprange --src-range 192.168.52.1-192.168.55.254 -j MASQUERADE
